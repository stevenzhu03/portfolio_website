    ...
    <div className="landing-page">
      <div className="landing-page-content">
        ...
        <div className="landing-page-icons">
          <a
            href="https://www.linkedin.com/in/steven-zhu-a4b989115/"
            target="_blank"
          ...
          <a
            href="https://medium.com/@stevenzhu03"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
      ...
      <Link to="/about_me#about_me" className="landing-page-link">
        <img src={require("../assets/arrows.svg")} width="75px" height="75px" alt="down"/>
      </Link>
    </div>
  );
};
